...
<head>
    ...
    <style>
        ...
        /* Skroll barni chiroyli qilish (ixtiyoriy) */
        ::-webkit-scrollbar { width: 5px; }
        ::-webkit-scrollbar-track { background: #f1f1f1; }
        ::-webkit-scrollbar-thumb { background: #cbd5e1; border-radius: 10px; }
    </style>
</head>
<body class="h-full overflow-hidden bg-slate-50"> <div class="flex h-screen overflow-hidden shadow-xl custom_bg">
        
        <div class="h-full flex-shrink-0 border-r border-gray-100 bg-white">
    ...
    <script>
        ...
        document.querySelectorAll('a').forEach(link => {
            link.addEventListener('click', (e) => {
                // Agar link tashqi saytga bo'lmasa yoki yangi oynada ochilmasa
