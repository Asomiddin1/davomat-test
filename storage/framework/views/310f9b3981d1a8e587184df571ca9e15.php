    ...
    <main class="flex-1 p-8">
        ...
        <div class="flex flex-wrap gap-3 mb-8">
            ...
            <button 
             ...
             <button 
                @click="activeFilter = 'PARTNER'"
                :class="{ 'bg-[#7D8ABC] text-white': activeFilter === 'PARTNER', 'bg-white text-gray-600 border border-gray-100 hover:bg-gray-50': activeFilter !== 'PARTNER' }"
                class="px-5 py-2 rounded-full text-sm transition-colors cursor-pointer">
                Hamkor Unversitet guruhlari
            </button>
                <button 
                    @click="activeFilter = 'WLU'"
                    :class="{ 'bg-[#7D8ABC] text-white': activeFilter === 'WLU', 'bg-white text-gray-600 border border-gray-100 hover:bg-gray-50': activeFilter !== 'WLU' }"
                    class="px-5 py-2 rounded-full text-sm transition-colors cursor-pointer">
                    Jahon tillari Unversiteti guruhlari
                </button>
                <button 
                    @click="activeFilter = 'EMPLOYABILITY'"
                    :class="{ 'bg-[#7D8ABC] text-white': activeFilter === 'EMPLOYABILITY', 'bg-white text-gray-600 border border-gray-100 hover:bg-gray-50': activeFilter !== 'EMPLOYABILITY' }"
                    class="px-5 py-2 rounded-full text-sm transition-colors cursor-pointer">
                    Employability guruhlari
                </button>
        </div>
...
</html><?php /**PATH /home/asomiddin/Desktop/davomat-2/resources/views/admin/groups/groups.blade.php ENDPATH**/ ?>