                ...
                <table class="w-full" id="studentsTable">
                    ...
                    <tbody id="studentsTableBody">
                        ...
                        <tr class="border-b hover:bg-gray-50 transition-colors">
                            <td class="p-4 text-gray-700"><?php echo e($index + 1); ?></td>
                            <td class="p-4 font-medium text-gray-800"><?php echo e($student->student_id); ?></td>
                            <td class="p-4 text-gray-800"><?php echo e($firstName); ?></td>
                            <td class="p-4 text-gray-700"><?php echo e($lastName); ?></td>
                            <td class="p-4 text-gray-700"><?php echo e($student->phone_number ?? '-'); ?></td>
                            <td class="p-4 text-gray-700"><?php echo e($student->email); ?></td>
                            <td class="p-4">
...
<div id="createModal" class="hidden fixed inset-0 bg-black/50 flex justify-center items-center z-50 p-4">
    <div class="bg-white w-full max-w-md rounded-xl shadow-lg">
        ...
        <!-- Modal Content -->
        <form method="POST" action="<?php echo e(route('admin.create.student.post')); ?>" class="p-6">
            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /home/asomiddin/Desktop/davomat-2/resources/views/admin/create-student.blade.php ENDPATH**/ ?>