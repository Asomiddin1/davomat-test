    ...
    <div class="min-h-screen bg-indigo-50 p-8 font-sans">
        <div class="max-w-6xl mx-auto bg-white rounded-3xl p-6 shadow-sm flex items-center justify-between mb-6">
            <div class="flex items-center space-x-4">
                <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($student->fullname)); ?>&background=random" alt="Avatar" class="w-20 h-20 rounded-full border-2 border-indigo-100">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800"><?php echo e($student->fullname); ?></h1>
                    <p class="text-gray-500">ID: <?php echo e($student->student_id); ?></p>
                </div>
            </div>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-50">
                ...
                <p class="font-bold text-gray-800"><?php echo e($student->phone_number); ?></p>
            </div>
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-50">
                ...
                <p class="font-bold text-gray-800 text-xs break-all"><?php echo e($student->email); ?></p>
            </div>
...
<?php endif; ?><?php /**PATH /home/asomiddin/Desktop/davomat-2/resources/views/student/student-info.blade.php ENDPATH**/ ?>