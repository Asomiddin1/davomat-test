<div x-show="openSettings" x-cloak
    ...
    <div x-show="openSettings" x-transition
        ...
        <form method="POST" action="<?php echo e(route('admin.groups.update', $group->id)); ?>" class="mb-4">
            <?php echo csrf_field(); ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.groups.status', $group->id)); ?>" class="mb-4">
            ...
            <select name="status"
                ...
                <option value="active" <?php echo e($group->status == 'active' ? 'selected' : ''); ?>>
                    Active
                </option>
                <option value="inactive" <?php echo e($group->status == 'inactive' ? 'selected' : ''); ?>>
                    Inactive
                </option>
            </select>
...
<?php /**PATH /home/asomiddin/Desktop/davomat-2/resources/views/admin/groups/settings-modal.blade.php ENDPATH**/ ?>